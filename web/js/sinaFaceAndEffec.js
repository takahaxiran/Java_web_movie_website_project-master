    ...
    $.fn.SinaEmotion = function (target) {
        ...
        $(this).click(function (event) {
            ...
            if ($('#emotions .categorys')[0]) {
                $('#emotions').css({top: eTop, left: eLeft, 'z-index': '9999'});
                $('#emotions').toggle();
                return;
            }
            ...
            $('#emotions').html('<div style="float:right" class="text-center">' +
                '<a href="javascript:void(0);" id="prev" style="height: 18px">&laquo;</a>' +
                '<a href="javascript:void(0);" id="next" style="height: 18px">&raquo;</a>' +
                '</div>' +
        ...
        function showEmotions() {
            ...
            for (var i = 0; i < emotions[category].length; ++i) {
                $('#emotions .container').append($('<a href="javascript:void(0);" style="width: 30px; height: 30px"  title="' + emotions[category][i].name + '"><img src="' + emotions[category][i].icon + '" alt="' + emotions[category][i].name + '" width="22" height="22" /></a>'));
            }
