...
THREE.Color.prototype = {
    ...
    setHSV: function (a, b, c) {
        var d,
            ...
            e;
        if (c === 0)
            this.r = this.g = this.b = 0; else switch (d = Math.floor(a * 6), f = a * 6 - d, a = c * (1 - b), e = c * (1 - b * f), b = c * (1 - b * (1 - f)), d) {
            case 1:
                this.r = e;
                this.g = c;
                this.b = a;
            ...
            if (J = w.objects[a].object, t = J.matrixWorld, x = J.material, m = 0, J instanceof THREE.Mesh) {
                ...
                for (L = M.length; S < L; S++) {
                    ...
                    if (B instanceof THREE.Face3)
                        if (v = l[B.a], R = l[B.b], P = l[B.c], v.visible && R.visible && P.visible && (J.doubleSided || J.flipSided != (P.positionScreen.x - v.positionScreen.x) * (R.positionScreen.y - v.positionScreen.y) - (P.positionScreen.y - v.positionScreen.y) * (R.positionScreen.x - v.positionScreen.x) < 0)) V = n[i] = n[i] || new THREE.RenderableFace3, i++, j = V, j.v1.copy(v), j.v2.copy(R), j.v3.copy(P); else continue;
    ...
    this.render = function (a, j) {
        ...
        function Aa(a, b, c, d, e, g, h, i, j, m, o, n, l) {
            if (l.image.width != 0) {
                ...
                p = j * n - o * m;
                if (p == 0) {
                    if (fa[l.id] == void 0) b = document.createElement("canvas"), b.width = l.image.width, b.height = l.image.height, a = b.getContext("2d"), a.drawImage(l.image, 0, 0), fa[l.id] = a.getImageData(0, 0, l.image.width, l.image.height).data,
                        //						delete b;
                        b = fa[l.id];
